    ...
    <script>
        ...
        $("#target").on('click', function(event) {
            ...
            $.ajax({
                ...
                error: function(data) {
                if(data.responseJSON.errors.hasOwnProperty('charge')){
                        $("#charge-error").removeClass("hidden");
                        $("#charge-error").html(data.responseJSON.errors.charge[0]);
